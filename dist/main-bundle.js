...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "eece43e2f8398aa9fb94";
...
exports.default = {
	formatedNumber: function formatedNumber(n) {
		return ("0" + n).slice(-2);
	}
};
...
var workInput = document.getElementById('timer__work-time');
var restInput = document.getElementById('timer__rest-time');

var timer = void 0;
var timerProps = {};

playBtn.addEventListener('click', function (e) {
	if (timer instanceof _timer2.default) return;
	...
	timer = new _timer2.default(timerProps);
	timer.start();
});
...
stopBtn.addEventListener('click', function () {
	timer.stop();
	timer = null;
	console.log(timer instanceof _timer2.default);
});
...
var timerStatusMsg = document.getElementById('timer__status-msg');

var Timer = function () {
	function Timer() {
		var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : timerProps;
	...
	_createClass(Timer, [{
		key: 'timer',
		value: function timer(seconds, period) {
			var that = this,
			    m = void 0,
			    // minutes
			s = void 0; // seconds
			...
			that.interval = setInterval(function () {
				...
				document.getElementById('min').innerHTML = _functions2.default.formatedNumber(m);
				document.getElementById('sec').innerHTML = _functions2.default.formatedNumber(s);
				if (seconds <= 0) {
